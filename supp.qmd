...
## SCANERIO 1: With burrowing allowed (as per natural behaviour of sleepy lizard)
...
## SCENARIO 2: With burrowing not allowed (to see if that changes the pattern of body temperature and activity time)

# Now try comparing with the same model but with burrowing not allowed to see if that changes the pattern of body temperature and activity time.
