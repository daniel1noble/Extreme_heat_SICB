...
for (i in 1:nrow(points)) {
  locs[[i]] <- NicheMapR::micro_silo(loc = c(points[i,1], points[i,2]),
                                     ...
                                     maxshade = 80) # We'll simulate under shade as that's more relevant under extreme heat.
}
...
# Now try comparing with the same model but with burrowing not allowed to see if that changes the pattern of body temperature and activity time. Here Mx and min depth are irrelevent as burrowing is not allowed
